...
file_path_1 = f'/home/tom/delve/results_and_visualisation/{file_name_1}.tsv'
...
file_path_2 = f'/home/tom/delve/results_and_visualisation/{file_name_2}.tsv'
...
plt.tight_layout()
plt.savefig(f'/home/tom/delve/results_and_visualisation/plot_combined_baseline.png')
plt.show()"""
...
# Adjust the layout and save the figure
plt.tight_layout()
plt.savefig(f'/home/tom/delve/results_and_visualisation/plot_baseline_words.png')
plt.show()
...
# Adjust the layout and save the figure
plt.tight_layout()
plt.savefig(f'/home/tom/delve/results_and_visualisation/plot_combined_ai.png')
plt.show()
